...
PREFIX="finetune-zjmcore-dsv3-${MODEL_SIZE}-lr-${LR}-minlr-${MIN_LR}-bs-${BATCH_SIZE}-gbs-${GLOBAL_BATCH_SIZE}-seqlen-${SEQ_LEN}"

# 
dataset_option=" \
    --train-data-path ${TRAIN_DATA:-/mnt/cpfs/code/LLaMA-Factory/data/alpaca_gpt4_data_en.json} \
    --valid-data-path ${VALID_DATA:-/mnt/cpfs/code/LLaMA-Factory/data/alpaca_gpt4_data_en.json} \
    --test-data-path ${TEST_DATA:-/mnt/cpfs/code/LLaMA-Factory/data/alpaca_gpt4_data_en.json} \
