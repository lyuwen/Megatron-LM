...
ZJLM_PATH = os.getenv("ZJLM_PATH")
sys.path.insert(0, ZJLM_PATH)
from zjlm.trainers.megatron_sft_trainer import train_valid_test_datasets_provider, add_extra_args as _add_extra_args
...
def build_extra_valid_data_loaders(
    ...
    if is_distributed or parallel_state.get_tensor_model_parallel_rank() == 0:
...
if __name__ == "__main__":
    ...
    pretrain(
        ...
        forward_step,
        args_defaults={'tokenizer_type': '021Tokenizer'},
